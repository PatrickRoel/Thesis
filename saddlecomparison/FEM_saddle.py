...
def create_saddle(grid_size,grid_length,grid_height):
    # grid discretization
    # grid_size = 5
    # grid_length = 10
    # grid_height = 5
...
def fem_saddle(grid_size,grid_length,grid_height):
    saddleform = create_saddle(grid_size,grid_length,grid_height)
    converged,runtime = saddleform.solve(max_iterations=1000)
    coords = saddleform.coords_current
    coords = coords.reshape(-1, 3)
    return coords,runtime

if __name__ == "__main__":
    grid_size = 12
    grid_length = 10
    grid_height = 11
    coords,runtime = fem_saddle(grid_size,grid_length,grid_height)
