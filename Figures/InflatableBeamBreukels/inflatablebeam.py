...
ax2.grid()
ax2.scatter(df['Element Length (m)'], df['Deflection error (%)'], marker='+',color = "black",zorder=20)
ax2.set_xlabel('Element length (m)', fontsize=12)
ax2.set_ylabel('Deflection error (%)', fontsize=12)
