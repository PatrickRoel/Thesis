...
fig1.savefig('Saddle_initial.pdf', format='pdf', bbox_inches='tight')
fig2.savefig('Saddle_solved.pdf', format='pdf', bbox_inches='tight')
fig1.savefig('Saddle_initial.svg', format='svg', bbox_inches='tight')
fig2.savefig('Saddle_solved.svg', format='svg', bbox_inches='tight')
