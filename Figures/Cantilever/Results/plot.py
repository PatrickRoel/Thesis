...
ax1.plot(FEM_timoshenko2["Vertical_disp"],FEM_timoshenko2["Load_param"], linestyle="--",color="gray",label="FEM, DOF=6")
ax2.plot(FEM_timoshenko2["Horizontal_disp"],FEM_timoshenko2["Load_param"], linestyle="--",color="gray",label="FEM, DOF=6")
ax3.plot(FEM_timoshenko2["Beam_angle"],FEM_timoshenko2["Load_param"], linestyle="--",color="gray",label="FEM, DOF=6")
ax1.plot(FEM_timoshenko4["Vertical_disp"],FEM_timoshenko4["Load_param"], linestyle="--",color="purple",label="FEM, DOF=18")
ax2.plot(FEM_timoshenko4["Horizontal_disp"],FEM_timoshenko4["Load_param"], linestyle="--",color="purple",label="FEM, DOF=18")
ax3.plot(FEM_timoshenko4["Beam_angle"],FEM_timoshenko4["Load_param"], linestyle="--",color="purple",label="FEM, DOF=18")
