...
l2 = np.linalg.norm(n3-n2)


F1 = Vector(n1,n2/l1/2,linewidth=2,color="red",zorder=20)
F2 = Vector(n2, (n1-n2)/l1/2,linewidth=2,color="red",zorder=20)
F3 = Vector(n2, (n3-n2)/l2/2,linewidth=2,color="red",zorder=20)
F4 = Vector(n3, (n2-n3)/l2/2,linewidth=2,color="red",zorder=20)

p = Point(n1,color="black",facecolor="black",bgcolor="black",zorder=50)
p = Point(n2+[0,-0.05,0],color="black",facecolor="black",bgcolor="black",zorder=50)
p = Point(n3,color="black",facecolor="black",bgcolor="black",zorder=50)

spring = Line(n1,n2,linewidth=2)
spring2 = Line(n2,n3-n2,linewidth=2)


ax.annotate3D(r'$\text{n}_1$', xyz=n1+[-0.4,-0.2,0], xytext=(0,0))
ax.annotate3D(r'$\text{n}_2$', xyz=n2+[-0.2,0.1,0], xytext=(0,0))
ax.annotate3D(r'$\text{n}_3$', xyz=n3+[0.1,-0.2,0], xytext=(0,0))


ax.annotate3D(r'$\textbf{f}_\text{int}$', xyz=n1+[0.0,0.3,0], xytext=(0,0), color= "red")
ax.annotate3D(r'$\textbf{f}_\text{int}$', xyz=n2+[-0.7,0.00,0], xytext=(0,0),  color= "red")
ax.annotate3D(r'$\textbf{f}_\text{int}$', xyz=n2+[0.25,-0.1,0], xytext=(0,0),  color= "red")
ax.annotate3D(r'$\textbf{f}_\text{int}$', xyz=n3+[-0.1,0.2,0], xytext=(0,0),  color= "red")
...
n_half2 = n2_lower+0.5*(n3_lower-n2_lower)

# p = Point(n1_lower,color="black",facecolor="black",bgcolor="black",zorder=50)
# p = Point(n_half2,color="black",facecolor="black",bgcolor="black",zorder=50)

l1 = Vector(n_half,n1_lower-n_half,linewidth=.75)
l2 = Vector(n_half,n2_lower-n_half,linewidth=.75)
l3 = Vector(n_half2,n2_lower-n_half2,linewidth=.75)
l4 = Vector(n_half2,n3_lower-n_half2,linewidth=.75)


ax.annotate3D(r'$l_{12}$', xyz=n_half-[-0.0,0.3,0], xytext=(0,0))
ax.annotate3D(r'$l_{23}$', xyz=n_half2-[0.25,0.2,0], xytext=(0,0))
...
# save_svg('pulley')
save_svg_tex('pulley',scour=True,fontsize=28)
